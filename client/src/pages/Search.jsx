...
const Search = () => {
  ...
  return (
    <div className='flex flex-col md:flex-row'>
        ...
        <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                <div className="flex items-center gap-2">
                    ...
                    <input type="text" id='searchTerm' placeholder='Search...' className='border rounded-lg p-3 w-full' value={setSidebardata.searchTerm} onChange={handleChange}/>
                </div>
                ...
                <div className="flex items-center gap-2">
                        ...
                        defaultChecked={'created_at_desc'} id="sort_order" className='border rounded-lg p-3'>
        ...
        {/* right */}
        <div className=''>
            <h1 className='text-3xl font-semibold border-b-3 p-3 '>Listing results:</h1>
        </div>
    </div>
  )
}
